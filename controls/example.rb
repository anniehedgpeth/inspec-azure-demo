...
control 'azurerm_virtual_machine' do
  describe azurerm_virtual_machine(resource_group: 'my-resources', name: 'my-vm') do
    it                                { should exist }
...
control 'azure_network_security_group' do
  describe azure_network_security_group(resource_group: 'my-resources', name: 'nsg') do
    it                            { should exist }
